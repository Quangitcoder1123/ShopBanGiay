            ...
            <div class="   text-center p-0 mt-3 mb-2">
                <div class="card-c px-0 pt-4 pb-0 mt-3 mb-3">
                    <div class="check-logo">
                        ...
                        <p class="text-logo">Đặt hàng cùng SP SHOP để nhận được nhiều khuyến mãi hấp dẫn
                        ...
                        <fieldset>
                            <div class="form-card">
                                <br><br>
                                <h2 class="purple-text text-center"><strong>Cám ơn bạn đã mua hàng tại SP SHOP  </strong>
                                </h2> <br>
                                <div class="row justify-content-center">
                                    <div class="col-3"> <img
