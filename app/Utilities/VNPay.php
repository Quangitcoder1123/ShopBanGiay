...
class VNPay
{
     ...
     *
     */
    static $vnp_TmnCode = "1FXGXVKO"; //Mã website tại VNPAY
    static $vnp_HashSecret = "SGFVZPAFELPCOPVMZLSFFASXMCAAKFQG"; //Chuỗi bí mật
    ...
    public static function vnpay_create_payment(array $data)
    {
        ...
        /* return env('APP_URL') . self::$vnp_Returnurl;*/
        $vnp_TxnRef = $data['vnp_TxnRef']; //Mã đơn hàng. Trong thực tế Merchant cần insert đơn hàng vào DB và gửi mã này sang VNPAY

        $vnp_OrderInfo = $data['vnp_OrderInfo'];
        $vnp_OrderType = '160002'; // Loại hàng hóa: Thực Phẩm - Tiêu Dùng (Xem thêm mã tại: https://sandbox.vnpayment.vn/apis/docs/loai-hang-hoa)
...
//        $vnp_BankCode = 'NCB';
        ...
        $inputData = array(
            ...
            "vnp_ReturnUrl" => 'http://127.0.0.1:8000/vnPayCheck',
